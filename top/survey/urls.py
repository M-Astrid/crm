...
urlpatterns = [
    ...
    url(r'^queries/(?P<pk>[0-9]+)/$', login_required(views.router)),
    url(r'^queries/(?P<pk>[0-9]+)/query/$', login_required(views.query)),
    url(r'^queries/(?P<pk>[0-9]+)/lead/$', login_required(views.lead)),
    url(r'^queries/(?P<pk>[0-9]+)/lead/remove(?P<i>[0-9]+)/$', login_required(views.remove_item)),
    url(r'^queries/(?P<pk>[0-9]+)/create-order/$', login_required(views.create_order)),
    url(r'^queries/(?P<pk>[0-9]+)/order/$', login_required(views.order)),
    url(r'^queries/(?P<pk>[0-9]+)/closed/$', login_required(views.query)),
