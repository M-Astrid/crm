...
urlpatterns = [
    ...
    url(r'^clients/(?P<pk>[0-9]+)/edit/$', login_required(views.ClientEdit.as_view())),
    ...
    url(r'^queries/(?P<pk>[0-9]+)/$', login_required(views.query_card)),
    url(r'^queries/(?P<pk>[0-9]+)/to-lead/$', login_required(views.query_to_lead)),
    url(r'^queries/(?P<pk>[0-9]+)/create-order/$', login_required(views.create_order)),
    url(r'^queries/(?P<pk>[0-9]+)/confirm-order/$', login_required(views.confirm_order)),
    url(r'^queries/(?P<pk>[0-9]+)/item(?P<i>[0-9]+)/$', login_required(views.item_detail)),
    url(r'^queries/(?P<pk>[0-9]+)/remove(?P<i>[0-9]+)/$', login_required(views.remove_item)),
    ...
    url(r'^queries/(?P<pk>[0-9]+)/comment/$', login_required(views.edit_commentary)),
]
